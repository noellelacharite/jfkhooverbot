...
var SpeechConnectionFactory = (function () {
    ...
    Object.defineProperty(SpeechConnectionFactory.prototype, "Host", {
        get: function () {
            return Exports_2.Storage.Local.GetOrAdd("Host", "wss://c2epintcus-155edccd3f694f9eaa82ede8fd7504ae.api.cris.ai");
        },
        enumerable: true,
        configurable: true
    });
...
var konsole = __webpack_require__(9);
var CognitiveSpeech = __webpack_require__(22);
    ...
    SpeechRecognizer.prototype.startRecognizing = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, this.actualRecognizer.Recognize(eventhandler)];
            });
        });
    };
...
var CognitiveServicesHelper = (function () {
    function CognitiveServicesHelper(props) {
        var _this = this;
        this._tokenURL = "https://wuppe.api.cognitive.microsoft.com/sts/v1.0/issueToken";
        this._synthesisURL = "https://speech.platform.bing.com/tts/dev/frontend/synthesize/customvoice?deploymentId=e8fffba5-ebfe-47ce-8c0e-55625ddb96ef";
        ...
        for (var i = 0; i < nodes.length; ++i) {
            if (nodes[i].nodeName === "voice") {
                ...
                if (!processDone) {
                    ...
                    attribute.value = "Hoover reviewed Adapt"; //(synthesisProperties && synthesisProperties.voiceName) || this.fetchVoiceName(locale, gender);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(0);
var WebsocketMessageAdapter_1 = __webpack_require__(10);
...
var SpeechConnectionFactory_1 = __webpack_require__(17);
...
var RecognizerConfig_1 = __webpack_require__(18);
var ServiceTelemetryListener_Internal_1 = __webpack_require__(56);
var SpeechConnectionMessage_Internal_1 = __webpack_require__(57);
